...
PREVIOUS_STORYBOARD_REFERENCE_LABEL = "Khung storyboard trước đó (tham chiếu nối cảnh)"
PREVIOUS_STORYBOARD_REFERENCE_DESCRIPTION = (
    "Chỉ dùng để duy trì bố cục, tông màu và tính liên tục với cảnh trước; không phải để thêm nhân vật, trang phục hay đạo cụ mới; vui lòng tạo cảnh hiện tại theo prompt hiện tại."
)
