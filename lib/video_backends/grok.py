"""GrokVideoBackend — backend tạo video của xAI Grok."""
...
class GrokVideoBackend:
    """Backend tạo video của xAI Grok."""
    ...
    async def generate(self, request: VideoGenerationRequest) -> VideoGenerationResult:
        ...
        logger.info("Bắt đầu tạo video Grok: model=%s, duration=%ds", self._model, request.duration_seconds)
        ...
        logger.info("Đã tải video Grok xong: %s", request.output_path)
