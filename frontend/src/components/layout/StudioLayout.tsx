...
export function StudioLayout({ children }: StudioLayoutProps) {
  ...
  // Kết nối dòng SSE của task khi vào workspace
  ...
  return (
    <div className="flex h-screen flex-col bg-gray-950 text-gray-100">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          {/* Luôn render, chỉ ẩn khi thu gọn để giữ state */}
          <div
      ...
      {/* Nút trợ lý nổi khi thu gọn panel */}
      <button
        type="button"
        ...
        title="Mở rộng panel trợ lý"
        aria-label="Mở rộng panel trợ lý"
      >
