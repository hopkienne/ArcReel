...
function getDefaultDraftPath(): string {
  ...
  return isWindows
    ? String.raw`C:\Users\tên_của_bạn\AppData\Local\JianyingPro\User Data\Projects\com.lveditor.draft`
    : "/Users/tên_của_bạn/Movies/JianyingPro/User Data/Projects/com.lveditor.draft";
}
      ...
      {mode === "select" ? (
        <>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-gray-500">
                  Không gồm lịch sử phiên bản, kích thước nhỏ hơn
                </p>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div>
                <div className="text-sm font-medium text-gray-200">Toàn bộ dữ liệu</div>
                <p className="mt-0.5 text-xs text-gray-500">
                  Bao gồm đầy đủ lịch sử phiên bản
                </p>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div>
                <div className="text-sm font-medium text-gray-200">
                  Xuất dự thảo Jianying
                </div>
                <p className="mt-0.5 text-xs text-gray-500">
                  Tạo file ZIP dự thảo có thể nhập vào Jianying
                </p>
              </div>
            </button>
          </div>
        ...
        <>
          <div className="mb-3 flex items-center gap-2">
            ...
            <p className="text-xs font-medium text-gray-300">Xuất dự thảo Jianying</p>
          </div>
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-gray-700 bg-gray-800 px-2.5 py-1.5 text-sm text-gray-200 outline-none focus:border-indigo-500"
              >
                <option value="6">Jianying 6.0 trở lên (đề xuất)</option>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Đường dẫn thư mục dự thảo Jianying"
              ...
              <p className="mt-1.5 text-[11px] leading-relaxed text-gray-500">
                Hãy điền đầy đủ đường dẫn thư mục dự thảo Jianying. Mở Jianying -> Cài đặt -> Vị trí dự thảo để xem.
              </p>
            </div>
