  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="mb-5 rounded-xl border border-gray-800 bg-gray-950/40 p-4">
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            <span className="text-gray-500">Định dạng API</span>
          ...
          <div className="flex justify-between">
            ...
            <span className="text-gray-300">{provider.api_key_masked || "Chưa thiết lập"}</span>
          </div>
          <div className="flex justify-between">
      ...
      {provider.models.length > 0 && (
        <div className="mb-5">
          <div className="mb-2 text-sm text-gray-400">Danh sách mô hình</div>
