...
export function ProjectSettingsPage() {
  ...
  const guardedNavigate = useCallback((path: string) => {
    if (isDirty && !window.confirm("Bạn có thay đổi chưa lưu, chắc chắn muốn rời khỏi trang?")) return;
    navigate(path);
  }, [isDirty, navigate]);
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gray-950 overflow-y-auto">
      ...
      <div className="sticky top-0 z-10 flex items-center gap-3 border-b border-gray-800 bg-gray-950/95 px-6 py-4 backdrop-blur">
        ...
        <h1 className="text-lg font-semibold text-gray-100">Cài đặt dự án</h1>
      </div>
      ...
      <div className="mx-auto max-w-2xl px-6 py-8 space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Chọn riêng mô hình tạo cho dự án này, để trống sẽ theo mặc định toàn cục
          </p>
        </div>
          ...
          <>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
              ...
              <ProviderModelSelect
                ...
                allowDefault
                defaultHint={
                  globalDefaults.video ? `Mặc định toàn cục hiện tại: ${globalDefaults.video}` : undefined
                }
              />
            </div>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
              <div className="mb-3 text-sm font-medium text-gray-100">Mô hình hình ảnh</div>
              <ProviderModelSelect
                value={imageBackend}
                ...
                allowDefault
                defaultHint={
                  globalDefaults.image ? `Mặc định toàn cục hiện tại: ${globalDefaults.image}` : undefined
                }
              />
            </div>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
              ...
              <fieldset className="flex gap-4">
                <legend className="sr-only">Thiết lập tạo âm thanh</legend>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
              ...
              <p className="mb-2 text-xs text-gray-500">Ghi đè theo loại tác vụ, để trống sẽ theo mặc định toàn cục</p>
                ...
                {([
                  ...
                  <div key={label}>
                    ...
                    <ProviderModelSelect
                      ...
                      onChange={setter}
                      allowDefault
                      defaultHint="Theo mặc định toàn cục"
                      aria-label={label}
                    />
                  </div>
                ))}
