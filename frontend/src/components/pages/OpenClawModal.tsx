/**
 * Modal hướng dẫn tích hợp OpenClaw.
 * Vùng prompt (có thể sao chép, gồm URL skill.md động), hướng dẫn 3 bước, nút "Lấy API token".
 */
...
// Dữ liệu các bước sử dụng (tĩnh, đưa ra ngoài component để tránh tạo lại mỗi lần render)
const STEPS = [
  {
    step: "01",
    title: "Gửi prompt ở trên cho OpenClaw",
    desc: "Sao chép prompt, dán vào OpenClaw và gửi",
  },
  {
    step: "02",
    title: "OpenClaw học năng lực từ tài liệu Skill",
    desc: "OpenClaw sẽ tự đọc tài liệu Skill của ArcReel để nắm cách dùng mọi công cụ và API khả dụng",
  },
  {
    step: "03",
    title: "OpenClaw tương tác với ArcReel và tạo video",
    desc: "Mô tả nhu cầu sáng tạo của bạn, OpenClaw sẽ gọi ArcReel để quản lý dự án, tạo kịch bản và sản xuất video",
  },
] as const;
...
export function OpenClawModal({ onClose }: OpenClawModalProps) {
  ...
  // task 7.3: tự động theo địa chỉ truy cập hiện tại
  ...
  const systemPrompt = useMemo(
    () => `Học ${skillUrl} rồi làm theo skill để hiểu cách dùng ArcReel tạo video`,
    [skillUrl],
  );
  ...
  // task 7.4: điều hướng đến trang quản lý API Key
