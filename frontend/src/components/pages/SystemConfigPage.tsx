...
const SECTION_LIST: { id: SettingsSection; label: string; Icon: React.ComponentType<{ className?: string }> }[] = [
  ...
  { id: "media", label: "Chọn mô hình", Icon: Film },
  { id: "usage", label: "Thống kê sử dụng", Icon: BarChart3 },
      ...
      <header className="shrink-0 border-b border-gray-800 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Cấu hình hệ thống và quản lý truy cập API</p>
          </div>
        </div>
      </header>
            ...
            <div className="border-b border-amber-900/40 bg-amber-950/30 px-6 py-3">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-amber-200">
                  <span className="font-medium">Các cấu hình bắt buộc sau vẫn chưa hoàn tất:</span>
