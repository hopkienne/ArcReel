...
describe("StudioCanvasRouter", () => {
  ...
  it("runs character/clue callbacks and reports API failures with toast", async () => {
    ...
    await waitFor(() => {
      ...
      expect(useAppStore.getState().toast?.text).toContain("Da gui nhiem vu tao hinh nhan vat");
    ...
    await waitFor(() => {
      ...
      expect(useAppStore.getState().toast?.text).toContain("Cap nhat manh moi that bai");
    ...
    await waitFor(() => {
      ...
      expect(useAppStore.getState().toast?.text).toContain("Gui nhiem vu that bai");
    });
  ...
  it("runs timeline callbacks and handles generation failures", async () => {
    ...
    await waitFor(() => {
      ...
      expect(useAppStore.getState().toast?.text).toContain("Cap nhat Prompt that bai");
    });
    ...
    await waitFor(() => {
      ...
      expect(useAppStore.getState().toast?.text).toContain("Tao storyboard that bai");
    });
    ...
    await waitFor(() => {
      ...
      expect(useAppStore.getState().toast?.text).toContain("Tao video that bai");
    });
  });
});
