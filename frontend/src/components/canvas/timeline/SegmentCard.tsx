...
function TextColumn({
    ...
    return (
      <div className="flex h-full flex-col gap-1.5 p-3">
        ...
        <pre className="whitespace-pre-wrap text-sm leading-relaxed text-gray-300 font-sans">
          {s.novel_text || "(Chưa có nguyên văn)"}
        </pre>
        {noteSection}
      </div>
    );
  ...
  return (
    <div className="flex h-full flex-col gap-1.5 p-3">
      ...
      {dialogue.length === 0 ? (
        <p className="text-sm text-gray-500 italic">(Chưa có thoại)</p>
      ) : (
      ...
      <div className="flex flex-col gap-2">
        ...
        {isStructuredImage && imgDraft ? (
          ...
          <AutoTextarea
            ...
            placeholder="Mô tả khung hình storyboard..."
          />
        )}
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        {isStructuredVideo && vidDraft ? (
          ...
          <AutoTextarea
            ...
            placeholder="Mô tả chuyển động video..."
          />
        )}
      </div>
    </div>
            ...
            <ImageFlipReveal
              ...
              fallback={
                <div className="flex h-full w-full flex-col items-center justify-center gap-2 text-gray-600">
                  ...
                  <span className="text-xs">Chưa có storyboard</span>
                </div>
              }
            />
          </AspectFrame>
        ...
        {videoUrl ? (
          ...
          <div className="flex items-center justify-center rounded-lg border border-dashed border-gray-700 bg-gray-800/30 py-4">
            <span className="text-xs text-gray-600">
              {assets?.storyboard_image ? "Có thể tạo video" : "Cần tạo storyboard trước"}
            </span>
          </div>
        )}
        <div className="mt-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {segCost && (
              <span className="tabular-nums contents">
                ...
                <span className="text-[11px] text-gray-600">Ước tính</span>
