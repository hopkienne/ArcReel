      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Mô tả ngoại hình, tính cách, bối cảnh của nhân vật..."
            rows={3}
        ...
        <div>
          ...
          <input
            ...
            placeholder="Tùy chọn, ví dụ: dịu dàng nhưng uy nghiêm"
            className="w-full rounded-lg border border-gray-700 bg-gray-800 px-3 py-1.5 text-sm text-gray-200 placeholder-gray-500 outline-none focus:border-indigo-500"
          />
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-600">
            Dùng để giữ tạo hình nhân vật nhất quán ở các lần sinh ảnh sau
          </p>
        </div>
